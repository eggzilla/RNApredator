...
function tax_id_confirm(ref){
        		...
        		var code ="<form action=\"target_search.cgi\" id=\"submit-form\"  method=\"post\" enctype=\"multipart/form-data\">" +
                        ...
                        "<input name=\"fasta-file\" id=\"file-upload\" size=\"40\" type=\"file\" onchange=\"lock_sRNA_sequence_input(this)\"><br>"+
			"<input id=\"tax-id-submit\"  value=\""+ tax_id_value +"\" name=\"tax-id\" type=\"hidden\"  maxlength=\"30\">"+
                        ...
                        "<br>Please provide email-address for notification:<br>"+
                        "<input id=\"email-address\"  value=\"\" name=\"email\" type=\"text\" maxlength=\"50\">(optional)<br>"+
